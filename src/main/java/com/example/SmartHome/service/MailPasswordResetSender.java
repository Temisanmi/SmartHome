...
public class MailPasswordResetSender implements PasswordResetSender {
    ...
    public void send(User user, String rawToken) {
        ...
        String htmlBody = """
                <div style="font-family: Arial, sans-serif; max-width: 480px; margin: auto;">
                    <h2>Reset your Smart Home password</h2>
                    <p>Hi %s,</p>
        ...
        try {
            ...
            helper.setSubject("Reset your Smart Home password");
